        ...
        <div id="shareInterface" class="fixed inset-0 bg-black bg-opacity-35 flex flex-col items-center justify-center z-50 p-8">
                ...
                <div class="bg-white border rounded-lg shadow-lg p-6 w-[50%]">
                    ...
                    <div class="flex flex-row w-full justify-end">
                        <button id="closeShareInterface" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-3 rounded-full">
                    ...
                    <div id="searchedUsers" class="usersList flex flex-col mx-auto w-[90%] max-h-[70%] overflow-y-auto divide-y-2"></div>
