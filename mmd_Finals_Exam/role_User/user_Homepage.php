...
<html lang="en">
    <head>
        ...
        <title>Gdocs User Homepage</title>
            ...
            <!-- RECENT DOCUMENTS -->
                ...
                <div class="divide-y-2">
                    ...
                    <?php foreach ($recentDocuments as $document) {?>
                        ...
                        <!-- individual record -->
                        <div class="documents" data-doc-id="<?= $docId ?>" onclick="location.href='../workspace/main.php?docId=<?= $docId ?>'">
                            ...
                            <div class="documentContainer">
                                ...
                                <!-- delete button -->
                                <?php if ($document['access_type'] == 'owner') { ?>
                                    <div class="columnMisc">
                                        <button class="deleteBtn p-2 hover:bg-gray-200 rounded-full z-50">
