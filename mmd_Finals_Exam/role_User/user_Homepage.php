    ...
    <body>
        ...
        <div class="flex flex-col mx-auto max-w-[75%] max-h-fit ">
            ...
            <div class="flex flex-row flex-nowrap px-4 py-3 w-full font-semibold text-gray-800">
                ...
                <div class="w-2/12 text-center">Owned by</div>
                <div class="w-5/12 text-center">Last Opened</div>
                <div class="w-1/12 text-center">Sort</div>
            </div>
            ...
            <div class="w-full px-4 py-3 w-full font-semibold text-gray-800">Older Documents</div>
